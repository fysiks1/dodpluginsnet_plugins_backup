...
// =================================================================================================
public plugin_init() {
	register_plugin("Syn's Weapon Mod","3.003f1","DoD Synthetic")
	register_cvar("syns_weapon_mod", "v3.003f1 by Synthetic - www.rivurs.com",FCVAR_SERVER|FCVAR_SPONLY)
